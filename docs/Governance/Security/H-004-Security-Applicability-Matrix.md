...
Por tanto, SV-005, SV-006 de producto, SV-007, SV-008 y SV-009 quedan justificados como `NOT_APPLICABLE` en la baseline actual. El código de workflows sí es analizable y queda cubierto por SV-006A mediante CodeQL para GitHub Actions.
...
| SV-006A | GitHub Actions workflows | IMPLEMENTED | CodeQL | Run de CodeQL | Mientras existan workflows |
